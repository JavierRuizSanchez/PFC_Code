 ...
 * Use the [mis_pedidos.newInstance] factory method to
 * create an instance of this fragment.
 */
class mis_pedidos : Fragment() {
    ...
    override fun onCreateView(
        ...
        recyclerView = view.findViewById(R.id.RecyclerViewListPedido)
        recyclerView.layoutManager = LinearLayoutManager(requireContext())
        val adapter = MisPedidosAdapter(getMispedidos())
    ...
    private fun getMispedidos(): List<Mispedidos> {
        ...
        // Por ejemplo:
        val Pedido1 = Mispedidos("Nombre1", "Restaurante")
        val Pedido2 = Mispedidos("Nombre2", "Tienda")
        return listOf(Pedido1, Pedido2)
    }
